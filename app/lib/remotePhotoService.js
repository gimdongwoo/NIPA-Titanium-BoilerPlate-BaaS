...
exports.savePhoto = function (blobImage, imageName) {
  ...
  // remove All non Alpha-Numeric Characters, All multiple instances of white space, All NewLines
  var _imageName = imageName.replace(/[^a-z0-9]|\W+|\r?\n|\r/gmi, "_");

  // var blobOfBase64 = Titanium.Utils.base64encode(blobImage);

  // 이름의 확장자를 이용하여 파일 타입확인함.
  // var parseFile = new Parse.File(_imageName, {'base64' : blobOfBase64.getText()} );
  var parseFile = new Parse.File(_imageName, blobImage);
